import { BeneficiaryAdded } from "../generated/ZamBSCVestingPool/ZamBSCVestingPool"
...
export function handleBeneficiaryAdded(event: BeneficiaryAdded): void {
    ...
    vestingCount = updateVestingDate(vestingCount, event.block.timestamp) as VestingCount
    vestingCount.save()
