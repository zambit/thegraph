...
import { Blocked, BridgeBSC, Circulation, HolderCount, TotalSupply, TransactionCount, TransferCount, VestingCount, ParticipantCount, StackerCount} from "../generated/schema"
import { updateBlockedDay, updateBlockedHour, updateBlockedMonth, updateBlockedWeek, updateBridgeBSCDay, updateBridgeBSCHour, updateBridgeBSCMonth, updateBridgeBSCWeek, updateCirculationDay, updateCirculationHour, updateCirculationMonth, updateCirculationWeek, updateHolderDay, updateHolderHour, updateHolderMonth, updateHolderWeek, updateParticipantDay, updateParticipantHour, updateParticipantMonth, updateParticipantWeek, updateStackerDay, updateStackerHour, updateStackerMonth, updateStackerWeek, updateTransactionDay, updateTransactionHour, updateTransactionMonth, updateTransactionWeek, updateTransferDay, updateTransferHour, updateTransferMonth, updateTransferWeek, updateVestingDay, updateVestingHour, updateVestingMonth, updateVestingWeek } from "./period"
...
// Cann't do like that, it will cause an Error
...
export function updateBridgeDate(entity: BridgeBSC, amount: BigInt, timestamp: BigInt): BridgeBSC{
    let data = getDateByTimestamp(timestamp.toI32())
    entity.day = BigInt.fromI32(data[0])
    entity.week = timestamp.div(BigInt.fromI32(604800))
    entity.month = BigInt.fromI32(data[1])
    entity.year = BigInt.fromI32(data[2])
    updateBridgeBSCHour(amount, entity.transferredToBSC, timestamp)
    updateBridgeBSCDay(amount, entity.transferredToBSC, timestamp)
    updateBridgeBSCWeek(amount, entity.transferredToBSC, timestamp)
    updateBridgeBSCMonth(amount, entity.transferredToBSC, timestamp)
    return entity
}
...
export function updateStackerDate(entity: StackerCount, timestamp: BigInt): StackerCount {
    let data = getDateByTimestamp(timestamp.toI32())
    entity.day = BigInt.fromI32(data[0])
    entity.week = timestamp.div(BigInt.fromI32(604800))
    entity.month = BigInt.fromI32(data[1])
    entity.year = BigInt.fromI32(data[2])
    updateStackerHour(entity.totalStake, entity.count, timestamp)
    updateStackerDay(entity.totalStake, entity.count, timestamp)
    updateStackerWeek(entity.totalStake, entity.count, timestamp)
    updateStackerMonth(entity.totalStake, entity.count, timestamp)
    return entity
}