...
export class ZamBSCVestingPool extends ethereum.SmartContract {
  static bind(address: Address): ZamBSCVestingPool {
    return new ZamBSCVestingPool("ZamBSCVestingPool", address);
  }
