...
export class Bridge extends Entity {
  constructor(id: string) {
    ...
    this.set("totalTransferred", Value.fromBigInt(BigInt.zero()));
    this.set("transferredToETH", Value.fromBigInt(BigInt.zero()));
  ...
  get transferredToETH(): BigInt {
    let value = this.get("transferredToETH");
    return value!.toBigInt();
  }

  set transferredToETH(value: BigInt) {
    this.set("transferredToETH", Value.fromBigInt(value));
  }
...
export class BridgeHour extends Entity {
  constructor(id: string) {
    super();
    this.set("id", Value.fromString(id));
    ...
    this.set("transferredToETH", Value.fromBigInt(BigInt.zero()));
    this.set("transferredToBSC", Value.fromBigInt(BigInt.zero()));
    this.set("totalTransferredToETH", Value.fromBigInt(BigInt.zero()));
  ...
  save(): void {
    let id = this.get("id");
    assert(id != null, "Cannot save BridgeHour entity without an ID");
    if (id) {
      assert(
        id.kind == ValueKind.STRING,
        "Cannot save BridgeHour entity with non-string ID. " +
          'Considering using .toHex() to convert the "id" to a string.'
      );
      store.set("BridgeHour", id.toString(), this);
    }
  }

  static load(id: string): BridgeHour | null {
    return changetype<BridgeHour | null>(store.get("BridgeHour", id));
  }
  ...
  get totalTransferredToETH(): BigInt {
    let value = this.get("totalTransferredToETH");
    return value!.toBigInt();
  }

  set totalTransferredToETH(value: BigInt) {
    this.set("totalTransferredToETH", Value.fromBigInt(value));
  }
...
export class BridgeDay extends Entity {
  constructor(id: string) {
    super();
    this.set("id", Value.fromString(id));
  ...
  save(): void {
    let id = this.get("id");
    assert(id != null, "Cannot save BridgeDay entity without an ID");
    if (id) {
      assert(
        id.kind == ValueKind.STRING,
        "Cannot save BridgeDay entity with non-string ID. " +
          'Considering using .toHex() to convert the "id" to a string.'
      );
      store.set("BridgeDay", id.toString(), this);
    }
  }

  static load(id: string): BridgeDay | null {
    return changetype<BridgeDay | null>(store.get("BridgeDay", id));
  }
...
export class BridgeWeek extends Entity {
  constructor(id: string) {
    super();
    this.set("id", Value.fromString(id));
  ...
  save(): void {
    let id = this.get("id");
    assert(id != null, "Cannot save BridgeWeek entity without an ID");
    if (id) {
      assert(
        id.kind == ValueKind.STRING,
        "Cannot save BridgeWeek entity with non-string ID. " +
          'Considering using .toHex() to convert the "id" to a string.'
      );
      store.set("BridgeWeek", id.toString(), this);
    }
  }

  static load(id: string): BridgeWeek | null {
    return changetype<BridgeWeek | null>(store.get("BridgeWeek", id));
  }
...
export class BridgeMonth extends Entity {
  constructor(id: string) {
    super();
    this.set("id", Value.fromString(id));
  ...
  save(): void {
    let id = this.get("id");
    assert(id != null, "Cannot save BridgeMonth entity without an ID");
    if (id) {
      assert(
        id.kind == ValueKind.STRING,
        "Cannot save BridgeMonth entity with non-string ID. " +
          'Considering using .toHex() to convert the "id" to a string.'
      );
      store.set("BridgeMonth", id.toString(), this);
    }
  }

  static load(id: string): BridgeMonth | null {
    return changetype<BridgeMonth | null>(store.get("BridgeMonth", id));
  }
...
export class BridgeETH extends Entity {
  constructor(id: string) {
    super();
    this.set("id", Value.fromString(id));
  ...
  save(): void {
    let id = this.get("id");
    assert(id != null, "Cannot save BridgeETH entity without an ID");
    if (id) {
      assert(
        id.kind == ValueKind.STRING,
        "Cannot save BridgeETH entity with non-string ID. " +
          'Considering using .toHex() to convert the "id" to a string.'
      );
      store.set("BridgeETH", id.toString(), this);
    }
  }

  static load(id: string): BridgeETH | null {
    return changetype<BridgeETH | null>(store.get("BridgeETH", id));
  }
...
export class BridgeETHHourData extends Entity {
  constructor(id: string) {
    super();
    this.set("id", Value.fromString(id));
  ...
  save(): void {
    let id = this.get("id");
    assert(id != null, "Cannot save BridgeETHHourData entity without an ID");
    if (id) {
      assert(
        id.kind == ValueKind.STRING,
        "Cannot save BridgeETHHourData entity with non-string ID. " +
          'Considering using .toHex() to convert the "id" to a string.'
      );
      store.set("BridgeETHHourData", id.toString(), this);
    }
  }

  static load(id: string): BridgeETHHourData | null {
    return changetype<BridgeETHHourData | null>(
      store.get("BridgeETHHourData", id)
    );
  }
...
export class BridgeETHDayData extends Entity {
  constructor(id: string) {
    super();
    this.set("id", Value.fromString(id));
  ...
  save(): void {
    let id = this.get("id");
    assert(id != null, "Cannot save BridgeETHDayData entity without an ID");
    if (id) {
      assert(
        id.kind == ValueKind.STRING,
        "Cannot save BridgeETHDayData entity with non-string ID. " +
          'Considering using .toHex() to convert the "id" to a string.'
      );
      store.set("BridgeETHDayData", id.toString(), this);
    }
  }

  static load(id: string): BridgeETHDayData | null {
    return changetype<BridgeETHDayData | null>(
      store.get("BridgeETHDayData", id)
    );
  }
...
export class BridgeETHWeekData extends Entity {
  constructor(id: string) {
    super();
    this.set("id", Value.fromString(id));
  ...
  save(): void {
    let id = this.get("id");
    assert(id != null, "Cannot save BridgeETHWeekData entity without an ID");
    if (id) {
      assert(
        id.kind == ValueKind.STRING,
        "Cannot save BridgeETHWeekData entity with non-string ID. " +
          'Considering using .toHex() to convert the "id" to a string.'
      );
      store.set("BridgeETHWeekData", id.toString(), this);
    }
  }

  static load(id: string): BridgeETHWeekData | null {
    return changetype<BridgeETHWeekData | null>(
      store.get("BridgeETHWeekData", id)
    );
  }
...
export class BridgeETHMonthData extends Entity {
  constructor(id: string) {
    super();
    this.set("id", Value.fromString(id));
  ...
  save(): void {
    let id = this.get("id");
    assert(id != null, "Cannot save BridgeETHMonthData entity without an ID");
    if (id) {
      assert(
        id.kind == ValueKind.STRING,
        "Cannot save BridgeETHMonthData entity with non-string ID. " +
          'Considering using .toHex() to convert the "id" to a string.'
      );
      store.set("BridgeETHMonthData", id.toString(), this);
    }
  }

  static load(id: string): BridgeETHMonthData | null {
    return changetype<BridgeETHMonthData | null>(
      store.get("BridgeETHMonthData", id)
    );
  }
